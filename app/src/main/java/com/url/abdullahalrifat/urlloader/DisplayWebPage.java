...
public class DisplayWebPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = ProgressDialog.show(DisplayWebPage.this, "Please Wait For a While !!!", "Loading...");
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                Toast.makeText(DisplayWebPage.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
